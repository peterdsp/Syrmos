...
enum StationCoords {
    ...
    static let line1: [(id: String, name: String, nameEl: String, lat: Double, lon: Double)] = [
        ...
        ("M1_THI", "Thiseio", "Θησείο", 37.9766852, 23.7205356),
        ...
        ("M1_AGI", "Agios Nikolaos", "Άγιος Νικόλαος", 38.0069859, 23.7277292),
        ("M1_KAT", "Kato Patisia", "Κάτω Πατήσια", 38.0119208, 23.7286630),
        ("M1_AG2", "Agios Eleftherios", "Άγιος Ελευθέριος", 38.0203392, 23.7319353),
        ("M1_ANO", "Ano Patisia", "Άνω Πατήσια", 38.0241359, 23.7365181),
        ("M1_PER", "Perissos", "Περισσός", 38.0332002, 23.7450680),
        ("M1_PEF", "Pefkakia", "Πευκάκια", 38.0374108, 23.7505057),
        ("M1_NEA", "Nea Ionia", "Νέα Ιωνία", 38.0416198, 23.7554095),
        ("M1_IRA", "Irakleio", "Ηράκλειο", 38.0460142, 23.7665601),
        ...
        ("M1_KA2", "KAT", "ΚΑΤ", 38.0663647, 23.8042356),
        ("M1_KIF", "Kifissia", "Κηφισιά", 38.0733951, 23.8082198),
    ]
    ...
    static let line2: [(id: String, name: String, nameEl: String, lat: Double, lon: Double)] = [
        ...
        ("M2_PER", "Peristeri", "Περιστέρι", 38.0128856, 23.6957605),
        ("M2_AGI", "Agios Antonios", "Άγιος Αντώνιος", 38.0060932, 23.6997156),
        ("M2_SEP", "Sepolia", "Σεπόλια", 38.0025946, 23.7140361),
        ("M2_ATT", "Attiki", "Αττική", 37.9995336, 23.7226918),
        ("M2_STA", "Larissa Station", "Σταθμός Λαρίσης", 37.9922861, 23.7207006),
        ...
        ("M2_SY2", "Syngrou-Fix", "Συγγρού-Φίξ", 37.9646366, 23.7268038),
        ("M2_NEO", "Neos Kosmos", "Νέος Κόσμος", 37.9576551, 23.7283685),
        ("M2_AG2", "Agios Ioannis", "Άγιος Ιωάννης", 37.9564161, 23.7346772),
        ("M2_DAF", "Dafni", "Δάφνη", 37.9495529, 23.7372110),
        ("M2_AG3", "Agios Dimitrios", "Άγιος Δημήτριος", 37.9398434, 23.7407267),
        ("M2_ILI", "Ilioupoli", "Ηλιούπολη", 37.9290637, 23.7447546),
        ("M2_ALI", "Alimos", "Άλιμος", 37.9178695, 23.7440625),
    ...
    static let line3: [(id: String, name: String, nameEl: String, lat: Double, lon: Double)] = [
        ...
        ("M3_AGI", "Agia Varvara", "Αγία Βαρβάρα", 37.9899646, 23.6593530),
        ("M3_AG2", "Agia Marina", "Αγία Μαρίνα", 37.9968128, 23.6677666),
        ...
        ("M3_AMB", "Ambelokipoi", "Αμπελόκηποι", 37.9871894, 23.7576995),
        ("M3_PAN", "Panormou", "Πανόρμου", 37.9931964, 23.7635814),
        ("M3_KAT", "Katechaki", "Κατεχάκη", 37.9937402, 23.7767641),
        ("M3_ETH", "Ethniki Amyna", "Εθνική Άμυνα", 37.9991725, 23.7844882),
        ("M3_CHO", "Cholargos", "Χολαργός", 38.0048986, 23.7947223),
        ("M3_NOM", "Nomismatokopio", "Νομισματοκοπείο", 38.0090857, 23.8057861),
        ("M3_AG3", "Agia Paraskevi", "Αγία Παρασκευή", 38.0171203, 23.8125006),
        ("M3_CHA", "Chalandri", "Χαλάνδρι", 38.0216963, 23.8207595),
        ("M3_DOY", "Douk. Plakentias", "Δουκίσσης Πλακεντίας", 38.0239773, 23.8325569),
        ("M3_PAL", "Pallini", "Παλλήνη", 38.0045807, 23.8699500),
        ("M3_PEA", "Peania-Kantza", "Παιανία-Κάντζα", 37.9849428, 23.8700731),
        ("M3_KO2", "Koropi", "Κορωπί", 37.9125370, 23.8960768),
    ...
    static let tramT6: [(id: String, name: String, nameEl: String, lat: Double, lon: Double)] = [
        ...
        ("T6_NEO", "Neos Kosmos", "Νέος Κόσμος", 37.9569955, 23.7270853),
        ("T6_BAK", "Baknana", "Μπακνανά", 37.9546714, 23.7238777),
        ("T6_AEG", "Aegeou", "Αιγαίου", 37.9501464, 23.7189049),
        ("T6_AGI", "Ag. Fotinis", "Αγίας Φωτεινής", 37.9467388, 23.7150445),
        ("T6_ALE", "Meg. Alexandrou", "Μεγ. Αλεξάνδρου", 37.9427014, 23.7137932),
        ("T6_AGH", "Ag. Paraskevi", "Αγία Παρασκευή", 37.9402146, 23.7130260),
        ("T6_MED", "Medeas-Mykalis", "Μηδείας-Μυκάλης", 37.9371506, 23.7120552),
        ("T6_EVA", "Evangeliki Scholi", "Ευαγγελική Σχολή", 37.9333042, 23.7108485),
    ...
    static let tramT7: [(id: String, name: String, nameEl: String, lat: Double, lon: Double)] = [
        ...
        ("T7_AGI", "Agia Triada", "Αγία Τριάδα", 37.9449403, 23.6451956),
        ("T7_PL2", "Pl. Ippodameias", "Πλ. Ιπποδαμείας", 37.9474688, 23.6475793),
        ("T7_SYN", "34 Synt. Pezikou", "34ου Συντ. Πεζικού", 37.9485363, 23.6522544),
        ("T7_AND", "Androutsou", "Ανδρούτσου", 37.9478346, 23.6560463),
        ("T7_OMI", "Om. Skylitsi", "Ομ. Σκυλίτση", 37.9450359, 23.6609189),
        ("T7_PEA", "SEF", "ΣΕΦ", 37.9438634, 23.6638070),
        ("T7_NEO", "Neo Faliro", "Νέο Φάληρο", 37.9445726, 23.6685528),
        ...
        ("T7_AGH", "Ag. Skepi", "Αγία Σκέπη", 37.9340166, 23.6939305),
        ("T7_TRO", "Trocadero", "Τροκαντερό", 37.9313941, 23.6872264),
        ("T7_PAR", "Parko Flisvou", "Πάρκο Φλοίσβου", 37.9278472, 23.6884354),
        ...
        ("T7_KA2", "Kalamaki", "Καλαμάκι", 37.9096776, 23.7128631),
        ...
        ("T7_STA", "1st Ag. Kosma", "1η Αγ. Κοσμά", 37.8942956, 23.7211661),
        ("T7_NDA", "2nd Ag. Kosma", "2η Αγ. Κοσμά", 37.8907821, 23.7231968),
        ("T7_AG2", "Ag. Alexandros", "Άγ. Αλέξανδρος", 37.8850490, 23.7269291),
        ("T7_EL2", "Ellinon Olympionikon", "Ελλ. Ολυμπιονικών", 37.8811588, 23.7294629),
        ("T7_KEN", "Kentro Istioploias", "Κέντρο Ιστιοπλοΐας", 37.8758816, 23.7318572),
        ("T7_PL3", "Pl. Vergoti", "Πλ. Βεργωτή", 37.8714672, 23.7351894),
        ("T7_PA2", "Paralia Glyfadas", "Παραλία Γλυφάδας", 37.8677342, 23.7383803),
        ("T7_PAL", "Paleo Demarhio", "Παλαιό Δημαρχείο", 37.8646553, 23.7431856),
        ("T7_PL4", "Pl. Vaso Katraki", "Πλ. Βάσω Κατράκη", 37.8634672, 23.7475090),
        ("T7_AG3", "Ag. Metaxa", "Αγγ. Μεταξά", 37.8627144, 23.7514044),
        ("T7_PL5", "Pl. Esperidon", "Πλ. Εσπερίδων", 37.8601549, 23.7541971),
        ("T7_KOL", "Kolymvitirio", "Κολυμβητήριο", 37.8560908, 23.7542381),
        ("T7_ASK", "Asklipiio Voulas", "Ασκληπιείο Βούλας", 37.8496644, 23.7525900),
    ]
    ...
    static let suburbanA1: [(id: String, name: String, nameEl: String, lat: Double, lon: Double)] = [
        ...
        ("A1_LEY", "Lefka", "Λεύκα", 37.9555849, 23.6541235),
        ("A1_REN", "Rentis", "Ρέντης", 37.9622619, 23.6683076),
        ("A1_TAY", "Tavros", "Ταύρος", 37.9689397, 23.6942248),
        ("A1_ROY", "Rouf", "Ρουφ", 37.9736019, 23.7040087),
        ("A1_ATH", "Athens", "Αθήνα", 37.9931275, 23.7202839),
        ("A1_AGI", "Ag. Anargyroi", "Άγιοι Ανάργυροι", 38.0224583, 23.7186452),
        ("A1_PYR", "Pyrgos Vasilissis", "Πύργος Βασιλίσσης", 38.0400365, 23.7276759),
        ("A1_KAT", "Kato Acharnai", "Κάτω Αχαρναί", 38.0547251, 23.7328066),
        ("A1_MET", "Metamorfosi", "Μεταμόρφωση", 38.0600674, 23.7562064),
        ("A1_IRA", "Irakleio", "Ηράκλειο", 38.0567845, 23.7720928),
        ...
        ("A1_DOY", "Douk. Plakentias", "Δουκίσσης Πλακεντίας", 38.0247026, 23.8338693),
        ("A1_PAL", "Pallini", "Παλλήνη", 38.0054925, 23.8696405),
        ("A1_PEA", "Peania-Kantza", "Παιανία-Κάντζα", 37.9839819, 23.8698255),
        ("A1_KOR", "Koropi", "Κορωπί", 37.9133050, 23.8955043),
        ("A1_AIR", "Airport", "Αεροδρόμιο", 37.9368156, 23.9448470),
    ]
    ...
    static let suburbanA2: [(id: String, name: String, nameEl: String, lat: Double, lon: Double)] = [
        ...
        ("A2_DOY", "Douk. Plakentias", "Δουκίσσης Πλακεντίας", 38.0247026, 23.8338693),
        ("A2_PAL", "Pallini", "Παλλήνη", 38.0054925, 23.8696405),
        ("A2_PEA", "Peania-Kantza", "Παιανία-Κάντζα", 37.9839819, 23.8698255),
        ("A2_KOR", "Koropi", "Κορωπί", 37.9133050, 23.8955043),
        ("A2_AIR", "Airport", "Αεροδρόμιο", 37.9368156, 23.9448470),
    ]
