(async function () {
    ...
    const I18N = {
        ...
        el: {
            ...
            whatsnew_i1: "Hellenic Rail Atlas: νέος σχεδιασμός με απαντήσεις στη μια ματιά",
            whatsnew_i2: "Η Αριάδνη τώρα συνδέεται με σταθμούς και γραμμές: πάτα και πήγαινε κατευθείαν",
            whatsnew_i3: "Περιήγηση σε όλους τους σταθμούς με χάρτη και ετικέτες γραμμών",
            whatsnew_i4: "Εντοπισμός τοποθεσίας στο web για κοντινούς σταθμούς",
        ...
        sq: {
            ...
            whatsnew_i1: "Hellenic Rail Atlas: dizajn i ri me përgjigje në një shikim",
            whatsnew_i2: "Ariadne tani lidhet me stacione dhe linja: prek dhe shko direkt",
            whatsnew_i3: "Shfleto të gjitha stacionet me harta dhe etiketa linjash",
            whatsnew_i4: "Gjeolokalizim në web për stacionet më të afërta",
    ...
    const FARE_GROUPS = [
        { key: "athens", sections: ["single", "airport", "offers", "passes"],
          label: { en: "Athens - OASA", el: "Αθήνα - OASA", sq: "Athine - OASA", it: "Atene - OASA" } },
        { key: "thessaloniki", sections: ["thessaloniki"],
          label: { en: "Thessaloniki - OSETH", el: "Θεσσαλονίκη - OSETH", sq: "Selanik - OSETH", it: "Salonicco - OSETH" } },
    ...
    (function whatsNewWeb() {
        ...
        const bullets = lang === "el" ? [
            "Hellenic Rail Atlas: νέος σχεδιασμός με απαντήσεις στη μια ματιά.",
            "Η Αριάδνη τώρα συνδέεται με σταθμούς και γραμμές: πάτα και πήγαινε κατευθείαν.",
            "Περιήγηση σε όλους τους σταθμούς με χάρτη και ετικέτες γραμμών.",
            "Ανανεωμένη Εξερεύνηση με κάρτες προορισμών και πρόσφατους σταθμούς.",
            "Εντοπισμός τοποθεσίας στο web για κοντινούς σταθμούς.",
        ] : lang === "sq" ? [
            "Hellenic Rail Atlas: dizajn i ri me përgjigje në një shikim.",
            "Ariadne tani lidhet me stacione dhe linja: prek dhe shko direkt.",
            "Shfleto të gjitha stacionet me harta dhe etiketa linjash.",
            "Kartela Eksploro e ridizajnuar me karta destinacionesh dhe stacione të fundit.",
            "Gjeolokalizim në web për stacionet më të afërta.",
        ] : lang === "it" ? [
