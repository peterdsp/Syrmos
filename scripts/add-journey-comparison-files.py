"""Register the Plan comparison and selection Swift files in project.pbxproj.
...
Mirrors scripts/add-duo-posture-files.py.
"""
...
FILES = [
    ("JourneyComparison.swift", "iosApp/Core/Journey/JourneyComparison.swift",
     "JourneyDetail.swift", "JourneyDetail.swift"),
    ("JourneyComparisonTests.swift", None,
     "JourneyDetailTests.swift", "JourneyDetailTests.swift"),
]
