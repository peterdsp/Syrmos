"""Register the Duo six-posture policy Swift files in project.pbxproj.
...
FILES = [
    ("AdaptiveWorkspacePolicy.swift", "iosApp/DesignSystem/AdaptiveWorkspacePolicy.swift",
     "SyrmosAnimations.swift", "SyrmosAnimations.swift"),
    ("DuoPostureFixturesTests.swift", None,
