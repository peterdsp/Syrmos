"""Register the Duo reserved-region adapter Swift files in project.pbxproj.
...
Mirrors scripts/add-departure-grouping-files.py.
"""
...
FILES = [
    ("ReservedRegionAdapter.swift", "iosApp/DesignSystem/ReservedRegionAdapter.swift",
     "SyrmosAnimations.swift", "SyrmosAnimations.swift"),
    ("ReservedRegionAdapterTests.swift", None,
     "DuoSnapshotTests.swift", "DuoSnapshotTests.swift"),
]
